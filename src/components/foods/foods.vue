...
<div>
	<div class="recommend-wrapper">
    	<h3>推荐商家</h3>
		<div class="recommend-sec"  ref = "foodswrapper">
						...
						<div class="seller">
							...
							<div class="content">
								...
								<div class="price-sec">
									...
									<div class="detail"><span><i>{{item.seller.deliveryDistance}}</i>km</span><em>|</em><span class="time"><i>{{item.seller.deliveryTime}}</i>分钟</span></div>
								</div>
							</div>
						</div>
						<div class="benefit" :class="{'slideup':currentIndex === index && showFlag}" @click.stop.prevent = "showMore(index,$event)">
